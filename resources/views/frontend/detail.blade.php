        ...
        <div class="container">
            <div class="row mb-5">
                ...
                <div class="col-lg-6">
                    ...
                    </div><a class="text-dark p-0 mb-4 d-inline-block" href="#!"><i class="far fa-heart me-2"></i>Add
                        to wish list</a><br>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="product text-center skel-loader">
                        ...
                        <h6> <a class="reset-anchor" href="{{ route('frontend.detail') }}">Kui Ye Chen’s AirPods</a>
                        </h6>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="product text-center skel-loader">
                        ...
                        <h6> <a class="reset-anchor" href="{{ route('frontend.detail') }}">Air Jordan 12 gym red</a>
                        </h6>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="product text-center skel-loader">
                        <div class="d-block mb-3 position-relative"><a class="d-block"
                                href="{{ route('frontend.detail') }}l"><img class="img-fluid w-100"
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="product text-center skel-loader">
                        ...
                        <h6> <a class="reset-anchor" href="{{ route('frontend.detail') }}">Timex Unisex Originals</a>
                        </h6>
