                    ...
                    <div class="row">
                            ...
                            <div class="product text-center">
                                <div class="mb-3 position-relative">
                                    <div class="badge text-white bg-"></div><a class="d-block"
                                        href="{{ route('frontend.cart') }}"><img class="img-fluid w-100"
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.cart') }}">Kui Ye Chen’s
                                        AirPods</a></h6>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product text-center">
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.cart') }}">Air Jordan 12 gym
                                        red</a></h6>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product text-center">
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.cart') }}">Cyan cotton
                                        t-shirt</a></h6>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product text-center">
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.cart') }}">Timex Unisex
                                        Originals</a></h6>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product text-center">
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.cart') }}">Red digital
                                        smartwatch</a></h6>
                                <p class="small text-muted">$250</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product text-center">
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.cart') }}">Nike air max 95</a>
                                </h6>
                                <p class="small text-muted">$300</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product text-center">
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.cart') }}">Joemalone Women
                                        prefume</a></h6>
                                <p class="small text-muted">$25</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product text-center">
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.cart') }}">Apple Watch</a></h6>
                                <p class="small text-muted">$351</p>
                            </div>
                        </div>
                        <!-- PRODUCT-->
                        <div class="col-lg-4 col-sm-6">
                            <div class="product text-center">
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.cart') }}">Men silver Byron
                                        Watch</a></h6>
                                <p class="small text-muted">$351</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product text-center">
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.cart') }}">Ploaroid one step
                                        camera</a></h6>
                                <p class="small text-muted">$351</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product text-center">
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.cart') }}">Gray Nike running
                                        shoes</a></h6>
                                <p class="small text-muted">$351</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product text-center">
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.cart') }}">Black DSLR lense</a>
                                </h6>
                                <p class="small text-muted">$351</p>
                            </div>
                        </div>
